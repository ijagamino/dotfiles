	...
	config = function()
		...
		vim.api.nvim_create_autocmd("LspAttach", {
			...
			callback = function(event)
				...
				map("gd", telescope_builtin.lsp_definitions, "Go to [d]efinition")
				map("gr", telescope_builtin.lsp_references, "Go to [r]eferences")
				map("gI", telescope_builtin.lsp_implementations, "Go to [I]mplementation")
				map("<leader>lt", telescope_builtin.lsp_type_definitions, "[t]ype definition")
				map("<leader>ld", telescope_builtin.lsp_document_symbols, "[d]ocument symbols")
				map("<leader>lw", telescope_builtin.lsp_dynamic_workspace_symbols, "[w]orkspace symbols")
